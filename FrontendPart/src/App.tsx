...
import { ABOUT_US_PATH, CONTACTS_PATH, DETAILS_VACANCIES_PATH, DETAILS_WORKER_PATH, HOME_PATH, ORDER_WORK_PATH, PAGES_WITHOUT_LAYOUT, REGISTER_PATH, VACANCIES_PATH } from './routs/routs';
