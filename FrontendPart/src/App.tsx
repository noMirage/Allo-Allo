...
import { ABOUT_US_PATH, CONTACTS_PATH, CREATE_RESUME, DETAIL_REGISTER, DETAILS_VACANCIES_PATH, DETAILS_WORKER_PATH, HOME_PATH, ORDER_WORK_PATH, PAGES_WITHOUT_LAYOUT, PROFILE_PATH, REGISTER_PATH, VACANCIES_PATH } from './routs/routs';
